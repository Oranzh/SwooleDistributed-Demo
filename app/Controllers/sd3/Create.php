...
class Create extends BaseController
{
    ...
    public function http_perform()
    {
        ...
        TimerCallBack::addTimer(5,TestModel::class,'testTimerCall',[123]);
        TimerCallBack::addTimer(10,TestModel::class,'testTimerCall2',[456]);
        $this->end('添加成功');
    }
    ...
    private function verify()
    {
        ...
        v::arrayVal()->key('id',v::intVal()->min(1,true))
