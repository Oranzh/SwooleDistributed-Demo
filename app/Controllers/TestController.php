...
class TestController extends Controller
{
    ...
    {
        throw new SwooleException('test_ex');
    ...
    public function testTcp2()
    {
        $this->sendToAllFd($this->client_data->data);
    }
    ...
    {
        $result = $this->redis_pool->getCoroutine()->set('testroute','123');
        $this->http_output->end($result, false);
    }
    ...
    {
        $res = $this->config->get('mailer','nonono');
        //$this->log('hahahhaha');
