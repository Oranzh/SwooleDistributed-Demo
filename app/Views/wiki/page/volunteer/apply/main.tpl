...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">志愿者申请列表</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
...
<!--								<td>{$item.name}</td>-->
								...
								<td>
									<div class="btn-group">
										<a href='/radishadmin/volunteer/particulars?id={$item.id}' type="button" class="btn btn-xs btn-info">
		...
		<script type="text/javascript" src="//img.oranzh.cc/wiki/static/page/volunteer/apply/index_a36793e.js"></script>
