...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Banner 详情</h1>
      </div>
    </div>
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <div class="row clearfix">
              ...
              <div class="col-lg-12">
                <p>缩略图：
                  <a href="{$list.images.b}" target="_blank"><img src="{$list.images.s}" style="width:50px"></a>
              </div>
							<div class="col-lg-12">
                <p>区域：
              ...
              <div class="col-lg-12">
                <p>链接地址：
                  <span class="text-muted"><a href="{$list.link}" target="_blank">{$list.link}</a></span></p>
              </div>
            </div>
          </div>
        </div>
